...
public class URLConstant {
	...
	public static final String URL_NEWS_PAGINATION = "tin-tuc/trang-{page}.html";
	public static final String URL_NEWS_DETAIL = "chi-tiet-tin-tuc-{id}.html";
	...
	public static final String URL_ADMIN_PRODUCT_UPDATE_PICTURE = "san-pham/cap-nhat-hinh-anh-san-pham-{productId}/hinh-anh-{pictureId}.html";
