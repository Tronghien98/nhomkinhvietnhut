        ...
        <c:if test="${not empty listProducts}">
        	<c:forEach items="${listProducts}" var="product">
        		<div class="col-xl-3 col-md-4 col-sm-6 project ui cat-${product.cat.id}">
		            <a href="./chi-tiet-san-pham-${product.id}.html" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
		                <img class="service card-img" src="${urlImageProduct}/${product.picture}" alt="Card image">
        ...
        <c:forEach items="${listNews}" var="news">
        	 <div class="col-md-4 mb-3">
                <a href="/" class="recent-work card border-0 shadow-lg overflow-hidden">
                    <img class="recent-work-img card-img" src="${urlNewProduct}/${news.picture}" alt="Card image">
