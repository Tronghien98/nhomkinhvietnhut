...
<section class="container py-5">
    <div class="row justify-content-center my-5">
        <div class="filter-btns shadow-md rounded-pill text-center col-auto">
            ...
            <c:forEach items="${listCatNew}" var="catnew">
            	<a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4" data-filter=".danh-muc-${catnew.id}" href="#">${catnew.name}</a>
            </c:forEach>
        </div>
    </div>
    ...
    <div class="row projects gx-lg-5">
    	<c:if test="${not empty listNews}">
    		<c:forEach items="${listNews}" var="news">
    			<a href="./chi-tiet-tin-tuc-${news.id}.html" class="col-sm-6 col-lg-4 text-decoration-none project marketing social danh-muc-${news.cat.id}">
		            <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
		                <img class="card-img-top" src="${urlNewProduct}/${news.picture}" alt="...">
		                <div class="card-body">
		                    <h5 class="card-title light-300 text-dark">${stringUtil.setStringCompact(news.title, 20)}</h5>
    ...
    <div class="row">
        <div class="btn-toolbar justify-content-center pb-4 pagination" role="toolbar" aria-label="Toolbar with button groups">
