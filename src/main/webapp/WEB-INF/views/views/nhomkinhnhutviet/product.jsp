    ...
    <div class="row projects gx-lg-5">
    	<c:if test="${not empty listProduct}">
    		<c:forEach items="${listProduct}" var="product">
    			<a href="./chi-tiet-san-pham-${product.id}.html" class="col-sm-6 col-lg-4 text-decoration-none project marketing social danh-muc-${product.cat.id}">
		            <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
		                <img class="card-img-top" src="${urlImageProduct}/${product.picture}" alt="...">
		                <div class="card-body">
