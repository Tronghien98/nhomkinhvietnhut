...
<head>
    ...
    <c:url value="/upload/upload/product/image" var="urlImageProduct" scope="application"></c:url>
    <c:url value="/upload/upload/news/image" var="urlNewProduct" scope="application"></c:url>
